  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Active Indicator Component</h1>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="p-4 bg-white border border-gray-200 rounded-lg">
                <h3 className="text-sm font-medium text-gray-900 mb-2">Dot Indicator</h3>
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Interactive Examples</h2>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">Toggle Switch</h3>
              ...
              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">Dot Indicator</h3>
                    <p className="text-sm text-gray-600">
          ...
          <div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="p-4 bg-white border border-gray-200 rounded-lg">
                <h3 className="text-sm font-medium text-gray-900 mb-2">Medium (Default)</h3>
                <ActiveIndicator isActive={true} onToggle={() => {}} />
              </div>
              <div className="p-4 bg-white border border-gray-200 rounded-lg">
