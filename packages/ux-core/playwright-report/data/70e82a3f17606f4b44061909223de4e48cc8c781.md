...
- Name: TeamHub UX Core Components >> Form Components >> FormActions component - action buttons
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:192:9
...
Locator: getByText('Form Actions Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Form Actions Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:196:67
```
