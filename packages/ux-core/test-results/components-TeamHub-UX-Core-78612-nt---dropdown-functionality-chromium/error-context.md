...
- Name: TeamHub UX Core Components >> Form Components >> EnhancedSelect component - dropdown functionality
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:169:9
...
Locator: getByText('Enhanced Select Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Enhanced Select Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:173:70
```
