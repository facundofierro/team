...
- Name: TeamHub UX Core Components >> Responsive Design Tests >> Components should be responsive on tablet
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:243:9
...
Call log:
  ...
  - waiting for locator('[data-testid="sidebar"]')
    ...
    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:247:61
```
