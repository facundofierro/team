...
- Name: TeamHub UX Core Components >> Data Display Components >> AgentCard component - agent information display
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:127:9
...
Locator: getByText('Agent Card Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Agent Card Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:131:65
```
