...
- Name: TeamHub UX Core Components >> Accessibility Tests >> All components should have proper ARIA labels
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:205:9
...
Call log:
  ...
  - waiting for getByRole('navigation')
    ...
    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:212:50
```
