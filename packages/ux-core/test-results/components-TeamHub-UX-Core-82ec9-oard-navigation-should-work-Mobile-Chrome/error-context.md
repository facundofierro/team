...
- Name: TeamHub UX Core Components >> Accessibility Tests >> Keyboard navigation should work
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:215:9
...
Call log:
  ...
  - waiting for locator(':focus')
    ...
    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:220:44
```
