...
- Name: TeamHub UX Core Components >> Layout Components >> Layout component - basic structure
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:100:9
...
Locator: getByText('Layout Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Layout Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:104:61
```
