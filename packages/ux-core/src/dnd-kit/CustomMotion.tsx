...
export const CustomMotion = memo(
  forwardRef<HTMLDivElement, CustomMotionProps<any>>((props, ref) => {
    const htmlTag =
      props['data-magicpath-motion-tag']?.split('.')[1] ||
      props['prevTag']?.split('.')[1]
    const MotionComponent = motion[htmlTag as keyof typeof motion]
    ...
    return (MotionComponent as any)({ ref, ...props, children: props.children })
  })
)
