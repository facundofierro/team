...
- Name: TeamHub UX Core Components >> Navigation Components >> StatusIndicator component - size variants
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:69:9
...
Locator: getByText('SM')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('SM')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:76:58
```
