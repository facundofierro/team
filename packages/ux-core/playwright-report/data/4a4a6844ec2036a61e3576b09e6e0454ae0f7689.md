...
- Name: TeamHub UX Core Components >> Responsive Design Tests >> Components should be responsive on mobile
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:233:9
...
Call log:
  ...
  - waiting for locator('[data-testid="sidebar"]')
    ...
    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:237:61
```
