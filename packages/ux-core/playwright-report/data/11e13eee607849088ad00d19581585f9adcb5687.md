...
- Name: TeamHub UX Core Components >> Layout Components >> ContentContainer component - responsive behavior
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:114:9
...
Locator: getByText('Content Container Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Content Container Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:118:72
```
