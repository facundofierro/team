...
- Name: TeamHub UX Core Components >> Navigation Components >> StatusIndicator component - interactive controls
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:80:9
...
Call log:
  - waiting for locator('select')
    ...
    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:84:18
```
