...
- Name: TeamHub UX Core Components >> Navigation Components >> StatusIndicator component - all status types
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:58:9
...
Call log:
  ...
  - waiting for getByText('active')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:65:64
```
