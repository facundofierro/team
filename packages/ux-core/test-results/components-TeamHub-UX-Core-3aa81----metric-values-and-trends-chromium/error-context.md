...
- Name: TeamHub UX Core Components >> Data Display Components >> MetricCard component - metric values and trends
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:134:9
...
Locator: getByText('Metric Card Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Metric Card Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:138:66
```
