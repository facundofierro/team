...
- Name: TeamHub UX Core Components >> Form Components >> EnhancedInput component - input validation and states
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:157:9
...
Locator: getByText('Enhanced Input Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Enhanced Input Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:161:69
```
