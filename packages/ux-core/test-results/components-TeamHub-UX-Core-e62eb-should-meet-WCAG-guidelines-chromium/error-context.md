...
- Name: TeamHub UX Core Components >> Accessibility Tests >> Color contrast should meet WCAG guidelines
- Location: /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:223:9
...
Locator: getByText('Status Indicator Component Test')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Status Indicator Component Test')

    at /Users/facundofierro/git/team/packages/ux-core/tests/components.spec.ts:228:71
```
